...
<div align="center">
  <a href="https://github.com/DeVuDeveloper/top-fashion">
    <img src="./app/assets/images/shop.jpg" alt="Logo" width="200" height="150">
  </a>

  <h1 align="center">Top Fashion App</h1>

  <p align="center">
   
  <a href="https://github.com/DeVuDeveloper/top-fashion#readme"><strong>Explore the docs »</strong></a>
    <br />
    <br />
    ·
    <a href="https://github.com/DeVuDeveloper/top-fashion/issues">Report Bug</a>
    ·
    <a href="https://github.com/DeVuDeveloper/top-fashion/issues">Request Feature</a>
  </p>
</div>

## Diagram

## ![Screenshot](app/assets/images/shop.jpg)


## Description 🏗️
An outstanding, modern application built with Ruby on Rails,
E-commerce with animations, list of products by category, men's and women's products, shopping cart and wishlist, payment with a card that is generated if saved, chatbot and much more...
...
```bash
git clone https://github.com/DeVuDeveloper/top-fashion.git
```
...
Feel free to check the [issues page](https://github.com/DeVuDeveloper/top-fashion).
