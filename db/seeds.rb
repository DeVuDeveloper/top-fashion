...
User.destroy_all
u1 = User.create(name: 'Admin', email: 'admin@mail.com', password: 'admin', admin: true, contact: '+223344556677', address: 'Paris');
...
Product.destroy_all
#Female products
p1 = Product.create(name: 'Hit', cost: 327, size: 'S', color: 'red', gender: 'women', brand:'Vero Moda', info: "Floral");
p2 = Product.create(name: 'Popular', cost: 757, size: 's', color: '', gender: 'women', brand:'Vero Moda', info: "Skirt");
p9 = Product.create(name: 'Hit', cost: 154, size: 's', color: 'black', gender: 'women', brand:'Monki', info: "Jacket");
p10 = Product.create(name: 'Hit', cost: 694, size: 's', color: 'black', gender: 'women', brand:'Neon Rose', info: "Gown");
p11 = Product.create(name: 'Popular', cost: 522, size: 's', color: 'silver', gender: 'women', brand:'Pimkie', info: "Sheer");
p12 = Product.create(name: 'Discount', cost: 459, size: 'm', color: 'floral', gender: 'women', brand:'Versace', info: "Dress");
...
#Male Products
p3 = Product.create(name: 'Discount', cost: 150, size: 'm', color: '', gender: 'men', brand:'Jack & Jones', info: "T-Shirt");
p4 = Product.create(name: 'Hit', cost: 157, size: 'm', color: 'blue', gender: 'men', brand:'Lee', info: "Jeans");
p5 = Product.create(name: 'Popular', cost: 495, size: 'l', color: 'black', gender: 'men', brand:'ASOS', info: "Jacket");
p6 = Product.create(name: 'Hit', cost: 269, size: 's', color: 'Navy', gender: 'men', brand:'Only & Sons', info: "jacket");
p7 = Product.create(name: 'Amazing', cost: 198, size: 'm', color: 'blue', gender: 'men', brand:'Wrangler', info: "Jeans");
p8 = Product.create(name: 'Hit', cost: 40, size: 'm', color: '', gender: 'men', brand:'Adidas', info: "Sport");
